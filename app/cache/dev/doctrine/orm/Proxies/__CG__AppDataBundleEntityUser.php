...
namespace Proxies\__CG__\App\DataBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \App\DataBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'App\\DataBundle\\Entity\\User' . "\0" . 'fname', '' . "\0" . 'App\\DataBundle\\Entity\\User' . "\0" . 'lname', '' . "\0" . 'App\\DataBundle\\Entity\\User' . "\0" . 'email', '' . "\0" . 'App\\DataBundle\\Entity\\User' . "\0" . 'password', '' . "\0" . 'App\\DataBundle\\Entity\\User' . "\0" . 'id');
        }
